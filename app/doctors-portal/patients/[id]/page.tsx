...
export default function PatientDetailPage({ params }: { params: { id: string } }) {
  ...
  const patient = {
    ...
    medicalHistory: [
      { condition: "Hypertension", diagnosedDate: "2023-06-15", status: "Active" },
      { condition: "Hypercholesterolemia", diagnosedDate: "2023-08-22", status: "Active" },
      { condition: "Appendectomy", diagnosedDate: "2010-03-10", status: "Resolved" },
    ],
    labResults: [
      {
        ...
        date: "2025-03-15",
        status: "Normal",
        highlights: "All values within normal range",
      },
      {
        name: "Lipid Panel",
        date: "2025-03-15",
        status: "Abnormal",
        highlights: "LDL cholesterol elevated (142 mg/dL)",
      },
      {
            ...
            <TabsContent value="medical-history" className="space-y-4">
              ...
              <div className="border rounded-lg">
                <div className="grid grid-cols-12 gap-4 p-4 border-b bg-muted/50 font-medium">
                  ...
                  <div className="col-span-3">Diagnosed</div>
                  <div className="col-span-2">Status</div>
                  <div className="col-span-2">Actions</div>
                </div>
                {patient.medicalHistory.map((item, index) => (
                  <div key={index} className="grid grid-cols-12 gap-4 p-4 border-b items-center">
                    <div className="col-span-5 font-medium">{item.condition}</div>
                    <div className="col-span-3">{new Date(item.diagnosedDate).toLocaleDateString()}</div>
              ...
              <div className="space-y-4">
                {patient.labResults.map((result, index) => (
                  <Card key={index}>
                    ...
                    <CardContent>
                      <div className="text-sm">{result.highlights}</div>
                    </CardContent>
                    <CardFooter className="pt-0">
                      <Button variant="outline" size="sm">
                        <FileText className="h-4 w-4 mr-2" />
